...
Bug reports and pull requests are welcome on GitHub at https://github.com/[USERNAME]/app_store_connect_api. This project is intended to be a safe, welcoming space for collaboration, and contributors are expected to adhere to the [code of conduct](https://github.com/[USERNAME]/app_store_connect_api/blob/main/CODE_OF_CONDUCT.md).
...
Everyone interacting in the AppStoreConnectApi project's codebases, issue trackers, chat rooms and mailing lists is expected to follow the [code of conduct](https://github.com/[USERNAME]/app_store_connect_api/blob/main/CODE_OF_CONDUCT.md).
